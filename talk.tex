...
\frame{
  \frametitle{Workflow - AREsite2\_CLIP\_analysis}
  \begin{itemize}
  \item Analyze CLIP data for AU-rich binding motifs
...
\frame{
  \frametitle{Workflow - PAR-CLIP analysis}
  \begin{itemize}
  \item Map interaction sites of RNA-binding proteins
  \item Quality control - Trim Galore
